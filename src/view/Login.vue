		...
		<div class="headertop">
			<div class="minheader">
				<div class="nav-link">
					<ul class="nav-link-ul">
						<li class="nav-link-item" id="one">
							<span> <a href="//www.bilibili.com" class="link van-popover__reference">
									...
									<span>主站</span>
									<svg aria-hidden="true" viewBox="0 0 1024 1024" class="navbar_pullup">
										<path
						...
						<li class="nav-link-item"><a href="//www.bilibili.com/anime/" target="_blank" class="link">番剧</a>
						</li>
						<li class="nav-link-item"><span>
								<a href="https://game.bilibili.com/platform/" target="_blank"
									class="link van-popover__reference" aria-describedby="van-popover-5450"
									tabindex="0">游戏中心</a>
							</span></li>
						<li class="nav-link-item"><span>
								<a href="//live.bilibili.com" target="_blank" class="link van-popover__reference"
									aria-describedby="van-popover-201" tabindex="0">直播</a>
							</span></li>
						<li class="nav-link-item"><a href="//show.bilibili.com/platform/home.html?msource=pc_web"
								target="_blank" class="link">会员购</a></li>
						<li class="nav-link-item"><span>
								<a href="//manga.bilibili.com?from=bill_top_mnav" target="_blank"
									class="link van-popover__reference" aria-describedby="van-popover-7621"
									tabindex="0">漫画</a>
							</span></li>
						<li class="nav-link-item"><a href="//www.bilibili.com/v/game/match/" target="_blank"
								class="link">赛事</a>
						</li>
						<li class="nav-link-item"><span>
								<a href="https://bml.bilibili.com/" target="_blank" class="link van-popover__reference"
									aria-describedby="van-popover-6095" tabindex="0">BML</a>
							</span></li>
						<!---->
						<li class="nav-link-item" id="two"><span>
								<a href="//app.bilibili.com" target="_blank" class="link van-popover__reference"
									aria-describedby="van-popover-8616" tabindex="0"><i
										class="bilifont"></i>下载APP</a>
							</span></li>
					</ul>
				</div>
				<div class="nav-search">
					<div id="nav_searchform">
						<form ><input type="text" autocomplete="off" accesskey="s" x-webkit-speech=""
							x-webkit-grammar="builtin:translate" placeholder="谢谢UP，今晚做梦有素材了" class="nav-search-keyword">
							<div class="nav-search-btn"><button type="button"></button></div>
						</form>
					</div>
				</div>
				<div class="nav-box">
					<div class="user-on">
						...
						<div data-v-a122b7b0="" class="unlogin-avatar">登录</div></router-link>
					</div>
					<div class="nav-over">
						<div class="name">
							大会员
			...
			<div class="head_foot_content">
				<div class="header">
					...
					<div class="lin">
						<div class="tit">
							<img src="../assets/images/t2.png" alt="登陆1">
						</div>
					</div>
					...
					<div class="content-l">
						<div class="inner">
							...
							<div class="tv1"></div>
							<div class="qrcode">
								<img src="../assets/images/qrcode.png" alt="二维码" id="qrcode1">
								<img src="../assets/images/qrcode2.png" alt="下载二维码" id="qrcode2">
							</div>
							<p class="qr-title">扫描二维码登录</p>
							<p class="qr-text">
								请使用
								<a href="#" onmouseover="qr_one()" onmouseout="qr_two()">哔哩哔哩客户端</a>
							</p>
							<img class="bg233" src="../assets/images/2233login.png" alt="233">
						</div>
					</div>
					<div class="line"></div>
					<div class="content-r">
						<form>
							<div class="loginname box">
								...
								<input type="text" placeholder="你的手机号/邮箱" id="loginname_text" onblur="loginname()">
							</div>
							<div class="loginpw box">
								<span id="loginpw_span"></span>
								<input type="password" placeholder="密码" id="loginpw_text" onblur="loginpw()">
							</div>
							<div class="loginic box">
								<div class="loginic_spana">
									<span id="loginic-span"></span>
									<a href="#">忘记密码？></a>
								</div>
								<p>
									<input type="checkbox" class="jz">&nbsp;&nbsp;记住我
									<span>不是自己的电脑上不要勾选此项</span>
								</p>
							</div>
							<div class="loginbu">
								<a href="#" id="denglu" onclick="denglu(); return false">登录</a>
								
								<router-link to="/Register"><a href="" class="zhuce">注册</a></router-link>
							</div>
						</form>
					</div>
				...
				<p class="tiaokuan">
					登录即代表你同意
				<a class="tkcolor" target="_blank" href="https://www.bilibili.com/protocal/licence.html">用户协议</a>
				和
				<a class="tkcolor" target="_blank" href="https://www.bilibili.com/blackboard/privacy-pc.html">隐私政策</a></p>
				</div>
			</div>
			<div class="footer">
				<div class="footer-wrp">
					<div class="footer-cnt">
						<ul class="boston-postcards">
							<li class="bilibili">
								<span class="tips">Bilibili</span>
								<span class="cards"><a href="#">关于我们</a></span>
								<span class="cards"><a href="#">友情链接</a></span>
								<a href="#"><img src="../assets/images/b-taobao.png" alt="淘宝"></a>
								<span class="cards"><a href="#">联系我们</a></span>
								<span class="cards"><a href="#">加入我们</a></span>
							</li>
							<li class="help">
								<span class="tips">帮助</span>
								<span class="cards"><a href="#">帮助中心</a></span>
								<span class="cards"><a href="#">补档认领处</a></span>
								<span class="cards"><a href="#">资源免责声明</a></span>
								<span class="cards"><a href="#">侵权申诉</a></span>
								<span class="cards"><a href="#">建议/BUG</a></span>
							</li>
							<li class="transfer">
								<span class="tips">传送门</span>
								<span class="cards"><a href="#">高级弹幕</a></span>
								<span class="cards"><a href="#">名人堂</a></span>
								<span class="cards"><a href="#">活动专题页</a></span>
								<span class="cards"><a href="#">资讯</a></span>
								<span class="cards"><a href="#">壁纸站</a></span>
								<span class="cards"><a href="#">分院帽计划</a></span>
								<span class="cards"><a href="#">活动中心</a></span>
							</li>
						</ul>
...
<style>
	...
	.top_bg{
		width: 100%;
		background: url(../assets/images/rl_topbg.png) repeat-x;
	}
	.top{
		width: 980px;
		height: 106px;
		margin: 0 auto;
		background: url(../assets/images/rl_top.png);
	}
	...
	.tv{
		...
		margin-left: 163px;
		margin-top: -60px;
		background: url(../assets/images/tv_animate.png) no-repeat;
	}
	.tv1{
		width: 70px;
		height: 70px;
	...
	.tv1:hover{-webkit-animation: tv1 1s steps(1) infinite;}

	@-webkit-keyframes tv1 { 
		0% {background-position: 0 0;} 
		6.25% {background-position: -80px 0;}
		12.5% {background-position: -160px 0;}
		18.75% {background-position: -240px 0;}
		25% {background-position: -320px 0;}
		31.25% {background-position: -400px 0;}
		37.5% {background-position: -480px 0;}
		43.75% {background-position: -560px 0;}
		50% {background-position: -640px 0;}
		56.25% {background-position: -720px 0;}
		62.5% {background-position: -800px 0;}
		68.75% {background-position: -880px 0;}
		75% {background-position: -960px 0;}
		81.25% {background-position: -1040px 0;}
		87.5% {background-position: -1120px 0;}
		93.75% {background-position: -1200px 0;}
	...
	.partner-banner{
		...
		width: 96px;
		height: 70px;
		background: url(../assets/images/footpic.gif);
		margin-right: 20px;
		margin-top: 5px;
	}
	.block-left{
	...
	.phone div{
		...
		width: 65px;
		height: 65px;
		background: url(../assets/images/icons.png) no-repeat -1020px -190px;
	}
	.phone div:hover{
		background: url(../assets/images/icons.png) no-repeat -1086px -190px;
		color: #00a1d6;
	}
	.weibo div{
		float: left;
		width: 65px;
		height: 65px;
		background: url(../assets/images/icons.png) no-repeat -1020px -318px;
	}
	.weibo div:hover{
		background: url(../assets/images/icons.png) no-repeat -1086px -318px;
		color: #00a1d6;
	}
	.weixin div{
		float: left;
		width: 65px;
		height: 65px;
		background: url(../assets/images/icons.png) no-repeat no-repeat -1020px -62px;
	}
	.weixin div:hover{
		background: url(../assets/images/icons.png) no-repeat -1086px -62px;
		color: #00a1d6;
	}
	...
	/*注册文本框*/
	.rename,.repw,.rephone,.rephone1{
		width: 417px;
		height: 82px;
		margin: 0 auto;
		position: relative;
	}
	.rename input,.repw input{
		width: 405px;
		height: 38px;
	...
	.loginname input,.loginpw input{
		width: 388px;
	}
	.loginname span,.loginpw span{
		display: block;
		width: 400px;
		height: 30px;
		font-size: 12px;
