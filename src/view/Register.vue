	...
	<div id="register">
		...
		<div class="top_bg">
			...
			<div class="foot_content">
				<div class="zcdl_content">
		
					<div class="lin">
						<div class="tit">
							<img src="../assets/images/t1.png" alt="登陆1">
						</div>
					</div>
					...
					<div class="center_title">
						<form>
							<div class="rename">
								<input type="text" class="rename-t" placeholder="昵称（例：哔哩哔哩）">
								<span class="re-tishi"></span>
							</div>
							<div class="repw">
								<input type="password" class="repws" placeholder="密码（6-16个字母，区分大小写）">
								<span class="re-tishi"></span>
							</div>
							<div class="rephone">
								...
								<input type="text" class="rephone-t" placeholder="填写常用手机号">
								<a href="#" class="rephone_a">用邮箱注册></a>
								<span class="re-tishi1"></span>
							</div>
							<div class="rephone1">
								<input type="text" placeholder="手机验证码" id="rephone1_text">
								<a href="#" class="rephone1_a">点击获取</a>
								<span class="re-tishi"></span>
								<label>
									<input type="checkbox" id="rephone1_acx" onclick="rephoneacx()">
									我已同意
...
<script src="./static/utils/register.js" type="text/javascript" charset="utf-8"></script>
<script src="./static/utils/jquery-2.2.3.min.js" type="text/javascript" charset="utf-8"></script>
<script>
	export default {
		data() {
			return {};
...
<script>
	t1 = document.querySelector('#next_step_sut'),
	t2 = document.querySelector('#next_step_sut1');
